package com.gungunpriatna.listviewapp;
...
public class HeroAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            //menghubungkan ke viewholder dengan view
            view = LayoutInflater.from(context).inflate(R.layout.item_hero, viewGroup, false);
        }

        //deklarasi viewholder
        ViewHolder viewHolder = new ViewHolder(view);

        //ubah nilai hero sesuai posisi
